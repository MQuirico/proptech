  ...
  return (
    <>
      <div className="container">
        ...
        <div className="content-personalizations">
          <div className="personalization">
            <h2 className="personalization-title">
              Personaliza tu financiación
            </h2>
            <p className="personalization-text">
              ¿No encontraste una opción que se ajuste a tus necesidades?
              Personaliza tu financiamiento de manera que funcione para ti,
